        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="tenNSX" class="form-control" required values="<?php echo $row_up['tenNSX']; ?>">
                </div>
                <div class="form-group">
                    <label for="">Địa chỉ</label>
                    <input type="text" name="diaChi" class="form-control" required values="<?php echo $row_up['diaChi']; ?>">
                </div>
                <div class="form-group">
                    <label for="">Số điện thoại</label>
                    <input type="number" name="soDT" class="form-control" required values="<?php echo $row_up['soDT']; ?>">
                </div>
