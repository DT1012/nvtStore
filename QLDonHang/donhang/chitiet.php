        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img style="width: 300px;" src="../image/<?php echo $row_SP['image']; ?>" alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"class="form-control" required value="<?php echo $row['tenKH']; ?>">
                </div>
                <div class="form-group">
                    <label for="">Người Mua</label>
                    <input type="text"class="form-control" required value="<?php echo $row['trangThai']; ?>">
                </div>
                <div class="form-group">
                    <label for="">Email</label>
                    <input type="text"class="form-control" required value="<?php echo $row['mail']; ?>">
                </div>
